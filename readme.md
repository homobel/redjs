...
* из mootools. Array 1.6 back compatibility. Позаимствовал пару названий для методов String/Number.prototype. Возможно и какой-то код для них.
